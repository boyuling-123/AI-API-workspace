...
export const PRESET_TARGETS: TargetConfig[] = [
  {
    ...
    resourceVersion: "v4-pro",
    resourceAliases: ["deepseek-v4", "deepseek-judge"],
    source: "manual",
    preset: true,
    status: "tested_ok",
  ...
  },
  {
    ...
    resourceKind: "model",
    capabilityTags: ["text_understanding", "image_understanding"],
    resourceVersion: "k2.6",
    resourceAliases: ["kimi-multimodal"],
    source: "manual",
    preset: true,
    status: "tested_ok",
    apiKeyRef: DASHSCOPE_KEY_REF,
  ...
  },
  {
    ...
    resourceKind: "model",
    capabilityTags: ["text_understanding", "image_understanding"],
    resourceVersion: "3.6-plus",
    resourceAliases: ["default-judge", "qwen-multimodal"],
    source: "manual",
    preset: true,
    status: "tested_ok",
    apiKeyRef: DASHSCOPE_KEY_REF,
  ...
  },
  {
    ...
    resourceAliases: ["mock-image", "image-main"],
    source: "manual",
    preset: true,
    status: "tested_ok",
    inputParams: [
