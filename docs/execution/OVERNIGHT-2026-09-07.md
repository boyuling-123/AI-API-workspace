...
| N13 共享观测声明校准 | 已创建PR，待最终CI | P0-A：UI/API/MCP区分固定真实LangGraph/Mock节点、未认证文件、任意Agent未兼容 | 两工具不扩权；源码/协议/API/UI一致；完整门禁和最终CI | PR55；299unit/2stress/quality、4专项与全量67 E2E无重试，截图/4成功Trace、467扫描通过；待最终CI |
