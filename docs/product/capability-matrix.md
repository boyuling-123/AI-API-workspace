...
| REPORT-006 | 人工修改评分、标记 Bad Case 和补充意见 | 已实现 | `evaluationReview.ts` 为任意评价目标追加不可变人工复核事件，保留 AI 原始维度分、加权分和否决状态；详情显示人工有效分与 AI 原分、Bad Case、修改人、理由和历史版本，排行榜继续明确使用 AI 原分；校准 Case 仍由专项复核队列处理 | 8 项真实源码单测覆盖追加版本、原分不变、同毫秒顺序、旧分精度、策略重算、脱敏、非法输入和篡改隔离；Mock E2E 覆盖两轮改分、Bad Case、必填拦截、刷新持久化、排行榜口径、390px、WCAG 和零新增调用；待独立环境与 GitHub CI | 人工覆盖保留原 AI 分数、修改人和理由 | 报告复核 | 待关联（基线 [PR #35](https://github.com/boyuling-123/AI-API-workspace/pull/35)） |
