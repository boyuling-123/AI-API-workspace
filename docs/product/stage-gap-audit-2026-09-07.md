...
2026-09-07 用户追加纠偏：优先重构实际主工作台的一级页面和二级导航，而不是继续扩展演示外壳。新增 [F-UI-001 规格](../features/F-UI-001/spec.md) 与 [执行纪实](../features/F-UI-001/plan.md)；本次导航改造不改变以下 75/72 项历史统计，也不代表版本化业务实体已实现。
